<%-- 
    Document   : cart
    Created on : Nov 2, 2018, 12:53:14 PM
    Author     : ThanhLich
--%>
                                            ...
                                            <c:forEach var="rows" items="${shop}">
                                                ...
                                                <tr>
                                                    <td class="product-thumbnail">
                                                        <img src="../images/${rows.value.sanpham.image}" alt="Image" class="img-fluid">
                                                    </td>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row mb-5">
                                ...
                                <div class="col-md-6">
                                    <a href="../product/shop.htm" class="btn btn-outline-primary btn-sm btn-block" >Continue Shopping</a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
