                            ...
                            <div class="site-top-icons">
                                <ul>
                                    ...
                                    <c:if test="${sessionScope.USER == null}">
                                        ...
                                        <li><a href="../login/loginIndex.htm"> <span class="icon icon-person"></span></a></li>

                                    </c:if>
                                    <c:if test="${sessionScope.USER != null}">

<!--                                        <li><a href="#"> <span class="icon icon-person">${sessionScope.IMGUSER}</span></a></li> -->
                                    ...
                                    <c:choose>
                                        <c:when test="${sessionScope.WISHLIST_SIZE > 0}">
                                            ...
                                            <li><a href="#"><span class="icon icon-heart-o">${sessionScope.WISHLIST_SIZE}</span></a></li>
